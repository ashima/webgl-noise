...
so I cloned the "ashima-arts" repository here:

https://github.com/stegu/webgl-noise

This site is still heavily linked from all over the place on the
Internet, so I'm still (2024) maintaining it. However, I can't
promise that I will keep doing that. Use my clone instead.
